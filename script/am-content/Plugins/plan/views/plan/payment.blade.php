					...
					<table class="table table-striped table-hover text-center table-borderless">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('admin.plan.payment.approved',encrypt($plan->id)) }}" class="btn btn-primary"><i class="fa fa-eye"></i></a>
									<a href="{{ route('admin.plan.payment.delete',encrypt($plan->id)) }}" class="btn btn-danger cancel"><i class="fa fa-trash"></i></a>
								</td>
							</tr>
							@endforeach
						</tbody>
