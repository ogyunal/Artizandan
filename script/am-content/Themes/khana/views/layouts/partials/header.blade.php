        ...
        <div class="delivery-main-content sidebar text-center">
            ...
            <div class="delivery-toogle-action">
                ...
                <div class="custom-control custom-switch">
                    <input {{ Session::has('delivery_type') ? Session::get('delivery_type')['type'] == 0 ? 'checked' : '' : '' }} type="checkbox" name="delivery_type" onchange="delivery_pickup('{{ $store->slug }}')" value="0" class="custom-control-input" id="d_p"> <label class="custom-control-label" for="d_p">{{ __('Pick Up') }}</label>
