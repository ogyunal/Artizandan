            ...
            <div class="card card-primary">
              ...
              <form action="{{ route('rider.register') }}" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                     @php
                    $arr['title']='Password Confirmation';
                ...
                <div class="row">
                  <div class="col-6">
                      @php
                    $arr['title']='Contact Number 1';
                    $arr['name']='phone1';
                    $arr['type']='text';
                    $arr['id']='phone1';
                    $arr['placeholder']='Contact Number 1';
                    $arr['is_required']=true;
                    echo input($arr);
                    @endphp
                  </div>
                  ...
                  <div class="form-group col-6">
                     @php
                    $arr['title']='Contact Number 2';
                    $arr['name']='phone2';
                    $arr['type']='text';
                    $arr['id']='phone2';
                    $arr['placeholder']='Contact Number 2';
                    $arr['is_required']=true;
                    echo input($arr);
                    @endphp
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="form-group col-12">
                    ...
                    <input id="location_input" type="text" class="form-control" name="full_address" autocomplete="off">
