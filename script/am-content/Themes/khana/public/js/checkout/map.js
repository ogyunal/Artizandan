      ...
      if (status != google.maps.DistanceMatrixStatus.OK) {
        ...
        if (response.rows[0].elements[0].status === "ZERO_RESULTS") {
          ...
          var duration = response.rows[0].elements[0].duration;
                    ...
                    $('#delivery_fee').html(Math.floor(totalfee));
                    $('#shipping').val(Math.floor(totalfee));
                    $('#total_price').val(Math.floor(total_amount + totalfee));
                    $('#last_total').html(Math.floor(total_amount + totalfee));
                }
            }
        }
    }