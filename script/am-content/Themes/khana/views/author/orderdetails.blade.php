				...
				<div class="card">
					<div class="card-body">
						<div class="table-responsive">
							<table class="table table-hover text-center">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ $itemrow->qty ?? '' }}</td>
										<td>{{ strtoupper($currency->value) }}{{ $itemrow->total ?? '' }}</td>
							...
							@endif
							<p><b>Total: </b>  {{ strtoupper($currency->value) }}{{ $total+$info->shipping }}</p>
						</div>
					</div>
				</div>	
							...
							<div class="profile-widget-header">                     
								...
								<div class="profile-widget-items">
									<div class="profile-widget-item">
										...
										<div class="profile-widget-item-value">{{ strtoupper($currency->value) }}{{ number_format($total+$info->shipping,2) }}</div>
									</div>
									<div class="profile-widget-item">
